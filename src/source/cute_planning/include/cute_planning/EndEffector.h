...
public:
   ...
   enum EETypeEnum
   {
      ...
      FreeSpinInZEndEffector,      ///< 5 DoC in position and orientation
   ...
   enum ParamTypeEnum
   {
      ...
      AttachedLink,        ///< (SG, #EcU32|#EcString) Link to attach EE to
      AttachedOffset,      ///< (SG, actinSE::Array3,
                           ///<      actinSE::Orientation,
                           ///<      actinSE::CoordinateSystemTransformation)
                           ///<      Attachment offset from the link
