...
int main(int argc, char **argv)
{
    ...
    moveit::planning_interface::MoveGroupInterface arm("cute_arm");
    ...
    //设置第二个目标点
    joint_group_positions[1] = -1.2;  // radians
    ...
    robot_trajectory::RobotTrajectory rt(arm.getCurrentState()->getRobotModel(), "cute_arm");
